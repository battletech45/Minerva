                      ...
                      child: Container(
                        ...
                        child: Row(
                          ...
                          Icon(Icons.cabin_rounded),
                           ...
                           Text("11-A", style: TextStyle(fontSize: 16,fontWeight: FontWeight.w400),),
                          ],
                        ),
                      )
                    ),
                      ...
                      child: Container(
                        ...
                        child: Row(
                          ...
                          children: [
                           ...
                           Text("Yunus Emre Anadolu Lisesi", style: TextStyle(fontSize: 16,fontWeight: FontWeight.w400),),
                          ],
                        ),
                      )
                    ),
                      ...
                      child: Container(
                        ...
                        child: Row(
                          ...
                          children: [
                           ...
                           Text("Email",
                           style: TextStyle(fontSize: 16,fontWeight: FontWeight.w500 ),),
                           Text("student@example.com", style: TextStyle(fontSize: 16,fontWeight: FontWeight.w400),),
                          ],
                        ),
                      )
                    ),
